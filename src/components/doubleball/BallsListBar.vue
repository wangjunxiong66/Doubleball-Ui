...
<script type="text/babel">
    ...
    export default {
        ...
        methods: {
            ...
            initChart(){
                let myEchartRed = this.$echarts.init(this.$refs.myEchartRed);
                let myEchartBlue = this.$echarts.init(this.$refs.myEchartBlue);
            ...
            async getBallData(){
                ...
                // _this.initChart()
                // this.$http.get('http://localhost:8181/douballapi/getstatisticsdivide/').then(function (resp) {
                //     _this.dataListRed = resp.data.bean.redballsnum
                //     _this.dataListBlue = resp.data.bean.blueballsnum
                //     _this.initChart()
                // })
                const {data:res} = await this.$http.get("/getstatisticsdivide")
                console.log("res.data.redball"+res.data.redball)
                console.log("res.data.blueball"+res.data.blueball)
                this.dataListRed = res.data.redball
                this.dataListBlue = res.data.blueball
                this.initChart()
            }
        },
        mounted () {
